...
const HomePage: React.FC = () => {
  ...
  useEffect(() => {
    const loadHomePageData = async () => {
      try {
        ...
        const [eventsData, newsData, testimonialsData, latestSnippetData] =
          await Promise.all([
            cmsApi.getEvents(),
  ...
  return (
    <>
      ...
      <section className="relative flex items-center justify-center text-white bg-hero-pillars hero-h">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center max-w-5xl">
          ...
          <div
  className="animate-fadeIn grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto mt-24 md:mt-32 xl:mt-16"
...
>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-6 text-neutral-600">
                ...
                ethical conduct, and charitable endeavors among our members while
                maintaining the rich traditions of Freemasonry.
              </p>
              <div className="mt-8">
                <Link to="/about">
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
            ...
            <div className="bg-white rounded-lg p-6 shadow-soft hover:shadow-medium transition-all duration-300 text-center">
              ...
              <p className="text-neutral-600">
                We respect the beliefs, opinions, and dignity of all people.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-6 shadow-soft hover:shadow-medium transition-all duration-300 text-center">
              ...
              <p className="text-neutral-600">
                Through charitable work and community service, we strive to make
      ...
      {/* Stats, Countdown, Snippets, Events, News, Testimonials, CTA */}
      <StatsSection />
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
              {testimonials.slice(0, 3).map((testimonial) => (
                <TestimonialCard
                  key={testimonial.id}
                  testimonial={convertTestimonialData(testimonial)}
                />
              ))}
            </div>
          </div>
      ...
      <section className="py-20 bg-primary-600 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg mb-8 max-w-3xl mx-auto text-neutral-100">
            Discover the timeless values of Freemasonry and join a brotherhood dedicated to
            personal growth, community service, and lifelong friendship.
          </p>
