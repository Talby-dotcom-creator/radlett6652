...
import { BookOpen, Clock, Calendar, ArrowRight, Lightbulb, Quote } from 'lucide-react';
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <SectionHeading 
            ...
            subtitle="Short, meaningful thoughts to inspire and guide your Masonic journey"
            centered
          />
