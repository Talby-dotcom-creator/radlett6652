  ...
  useEffect(() => {
    const loadPageContent = async () => {
      try {
        ...
        // Get all page content for the privacy page using optimized API with caching
        const content = await dataCache.get(
          CACHE_KEYS.PAGE_CONTENT('privacy'), 
          () => optimizedApi.getPageContent('privacy'), 
          60 * 60 * 1000 // 1 hour cache for privacy content (rarely changes)
        );
