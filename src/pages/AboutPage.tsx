...
import { CMSOfficer, CMSPageContent } from '../types';
...
const AboutPage: React.FC = () => {
  ...
  useEffect(() => {
    const loadPageData = async () => {
      try {
        ...
        // Load both officers and page content using optimized API with caching
        const [officersData, contentData] = await Promise.all([
          dataCache.get(CACHE_KEYS.OFFICERS, () => optimizedApi.getOfficers(), 20 * 60 * 1000), // 20 min cache
          dataCache.get(CACHE_KEYS.PAGE_CONTENT('about'), () => optimizedApi.getPageContent('about'), 30 * 60 * 1000) // 30 min cache
        ]);
  ...
  const historyTitle = pageContent.history_title || 'Our History';
  const historyIntro = pageContent.history_intro || 'A journey through time: Exploring the rich heritage of Radlett Lodge No. 6652 since 1948.';
  const foundingStory = pageContent.founding_story || 'Radlett Lodge No. 6652 was founded by a diverse group of friends residing in Radlett in the aftermath of World War II. The founding members included a doctor, a local businessman, a farmer, and a Savile Row tailor, among others.';
  ...
  return (
    <>
      <HeroSection
        ...
        backgroundImage="https://images.pexels.com/photos/1797415/pexels-photo-1797415.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
      />
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div 
                  ...
                  dangerouslySetInnerHTML={{ __html: foundingStory }}
                />
