...
const MemberProfileAdminForm: React.FC<MemberProfileAdminFormProps> = ({ 
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm({
    defaultValues: {
      ...
      share_contact_info: initialData?.share_contact_info || false
    }
  });
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="flex items-center">
        ...
        />
        <label htmlFor="share_contact_info" className="ml-2 block text-sm text-neutral-700">
          Allow contact information to be shared in member directory
        </label>
      </div>
