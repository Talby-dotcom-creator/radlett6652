    ...
    <>
      <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
          ...
          <div className="mt-1 space-y-3">
            ...
            <div className="flex space-x-2">
              <input
                ...
                placeholder="https://example.com/document.pdf or use Media Manager to upload"
              />
              <Button
                type="button"
                variant="outline"
                onClick={() => setShowMediaManager(true)}
                className="flex items-center px-4 py-2 whitespace-nowrap bg-secondary-50 hover:bg-secondary-100 border-secondary-300"
              >
                ...
                <div className="flex items-center p-3 bg-neutral-50 border border-neutral-200 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-neutral-700">
                      {selectedDocumentUrl.split('/').pop() || 'Document'}
                    </p>
            ...
            <p className="text-xs text-neutral-500">
              You can paste a URL directly or use the Media Manager to upload files. 
              Supported formats: PDF, DOC, DOCX, TXT, and images.
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-end space-x-4">
          ...
          <Button 
            type="submit" 
            disabled={isSubmitting || !watchedValues.title?.trim() || !watchedValues.category || !(selectedDocumentUrl || watchedValues.url?.trim())}
          >
